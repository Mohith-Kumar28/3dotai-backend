...
export class ProductV202411Api {
   ...
   */
  public async ProductsDiagnoseOptimizePost(
    xTtsAccessToken: string,
    contentType: string,
    shopCipher?: string,
    DiagnoseandOptimizeProductRequestBody?: Product202411DiagnoseandOptimizeProductRequestBody,
    ...
    const localVarPath =
      this.basePath + '/product/202411/products/diagnose_optimize';
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling ProductsDiagnoseOptimizePost.',
      );
    }
    ...
    if (contentType === null || contentType === undefined) {
      throw new Error(
        'Required parameter contentType was null or undefined when calling ProductsDiagnoseOptimizePost.',
      );
    }
