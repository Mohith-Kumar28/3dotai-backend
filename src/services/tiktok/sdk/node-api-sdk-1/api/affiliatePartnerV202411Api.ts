...
export class AffiliatePartnerV202411Api {
  ...
  public setApiKey(key: AffiliatePartnerV202411ApiApiKeys, value: string) {
    (this.authentications as any)[
      AffiliatePartnerV202411ApiApiKeys[key]
    ].apiKey = value;
  }
  ...
  public async OrdersSearchPost(
    ...
    contentType: string,
    pageToken?: string,
    SearchTapAffiliateOrdersRequestBody?: AffiliatePartner202411SearchTapAffiliateOrdersRequestBody,
    ...
    const localVarPath =
      this.basePath + '/affiliate_partner/202411/orders/search';
    ...
    if (categoryAssetCipher === null || categoryAssetCipher === undefined) {
      throw new Error(
        'Required parameter categoryAssetCipher was null or undefined when calling OrdersSearchPost.',
      );
    }
    ...
    const localVarRequestOptions: localVarRequest.Options = {
      ...
      body: ObjectSerializer.serialize(
        SearchTapAffiliateOrdersRequestBody,
