...
export class DataReconciliationV202310Api {
  ...
  public setApiKey(key: DataReconciliationV202310ApiApiKeys, value: string) {
    (this.authentications as any)[
      DataReconciliationV202310ApiApiKeys[key]
    ].apiKey = value;
  }
  ...
  public async OrdersImportPost(
    ...
    contentType: string,
    shopCipher?: string,
    QualityFactoryOrderDataImportAPIRequestBody?: DataReconciliation202310QualityFactoryOrderDataImportAPIRequestBody,
    ...
    const localVarPath =
      this.basePath + '/data_reconciliation/202310/orders/import';
