...
export class ProductV202404Api {
   ...
   */
  public async ImagesOptimizePost(
    xTtsAccessToken: string,
    contentType: string,
    shopCipher?: string,
    OptimizedImagesRequestBody?: Product202404OptimizedImagesRequestBody,
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling ImagesOptimizePost.',
      );
    }
    ...
    if (contentType === null || contentType === undefined) {
      throw new Error(
        'Required parameter contentType was null or undefined when calling ImagesOptimizePost.',
      );
    }
          ...
          if (error) {
            ...
            if (
              ...
              body = ObjectSerializer.deserialize(
                body,
                'Product202404OptimizedImagesResponse',
              );
