...
export class AffiliateSellerV202410Api {
  ...
  public setApiKey(key: AffiliateSellerV202410ApiApiKeys, value: string) {
    (this.authentications as any)[
      AffiliateSellerV202410ApiApiKeys[key]
    ].apiKey = value;
  }
   ...
   * @param shopCipher
   */
  public async OpenCollaborationsSampleRulesGet(
    ...
    if (productIds === null || productIds === undefined) {
      throw new Error(
        'Required parameter productIds was null or undefined when calling OpenCollaborationsSampleRulesGet.',
      );
    }
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling OpenCollaborationsSampleRulesGet.',
      );
    }
    ...
    if (contentType === null || contentType === undefined) {
      throw new Error(
        'Required parameter contentType was null or undefined when calling OpenCollaborationsSampleRulesGet.',
      );
    }

    if (productIds !== undefined) {
      localVarQueryParameters['product_ids'] = ObjectSerializer.serialize(
        productIds,
        'Array<string>',
      );
    }
   ...
   */
  public async OpenCollaborationsSampleRulesPost(
    xTtsAccessToken: string,
    contentType: string,
    shopCipher?: string,
    EditOpenCollaborationSampleRuleRequestBody?: AffiliateSeller202410EditOpenCollaborationSampleRuleRequestBody,
    options: { headers: { [name: string]: string } } = { headers: {} },
  ): Promise<{
    response: http.IncomingMessage;
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling OpenCollaborationsSampleRulesPost.',
      );
    }
    ...
    if (contentType === null || contentType === undefined) {
      throw new Error(
        'Required parameter contentType was null or undefined when calling OpenCollaborationsSampleRulesPost.',
      );
    }
    ...
    const localVarRequestOptions: localVarRequest.Options = {
      ...
      body: ObjectSerializer.serialize(
        EditOpenCollaborationSampleRuleRequestBody,
  ...
  public async OrdersSearchPost(
    ...
    pageToken?: string,
    shopCipher?: string,
    SearchSellerAffiliateOrdersRequestBody?: AffiliateSeller202410SearchSellerAffiliateOrdersRequestBody,
    options: { headers: { [name: string]: string } } = { headers: {} },
  ): Promise<{
    response: http.IncomingMessage;
    ...
    const localVarPath =
      this.basePath + '/affiliate_seller/202410/orders/search';
    const localVarQueryParameters: any = {};
    const localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders,
    ...
    const localVarRequestOptions: localVarRequest.Options = {
      ...
      json: true,
      body: ObjectSerializer.serialize(
        SearchSellerAffiliateOrdersRequestBody,
...
export const AffiliateSellerV202410ApiOperationNames = {
  OpenCollaborationsSampleRulesGet: 'OpenCollaborationsSampleRulesGet',
  OpenCollaborationsSampleRulesPost: 'OpenCollaborationsSampleRulesPost',
