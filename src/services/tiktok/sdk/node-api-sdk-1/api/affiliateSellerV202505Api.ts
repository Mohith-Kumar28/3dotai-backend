...
export class AffiliateSellerV202505Api {
  ...
  public setApiKey(key: AffiliateSellerV202505ApiApiKeys, value: string) {
    (this.authentications as any)[
      AffiliateSellerV202505ApiApiKeys[key]
    ].apiKey = value;
  }
  ...
  public async ConversationsGet(
    ...
    shopCipher?: string,
    GetConversationListRequestBody?: AffiliateSeller202505GetConversationListRequestBody,
    ...
    const localVarPath =
      this.basePath + '/affiliate_seller/202505/conversations';
   ...
   * @param shopCipher
   */
  public async MarketplaceCreatorsCreatorUserIdGet(
    ...
    const localVarPath =
      this.basePath +
      '/affiliate_seller/202505/marketplace_creators/{creator_user_id}'.replace(
        '{' + 'creator_user_id' + '}',
        encodeURIComponent(String(creatorUserId)),
      );
    const localVarQueryParameters: any = {};
    const localVarHeaderParams: any = (<any>Object).assign(
      {},
    ...
    if (creatorUserId === null || creatorUserId === undefined) {
      throw new Error(
        'Required parameter creatorUserId was null or undefined when calling MarketplaceCreatorsCreatorUserIdGet.',
      );
    }
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling MarketplaceCreatorsCreatorUserIdGet.',
      );
    }
    ...
    if (contentType === null || contentType === undefined) {
      throw new Error(
        'Required parameter contentType was null or undefined when calling MarketplaceCreatorsCreatorUserIdGet.',
      );
    }
   ...
   */
  public async MarketplaceCreatorsSearchPost(
    pageSize: number,
    xTtsAccessToken: string,
    contentType: string,
    pageToken?: string,
    shopCipher?: string,
    SellerSearchCreatoronMarketplaceRequestBody?: AffiliateSeller202505SellerSearchCreatoronMarketplaceRequestBody,
    options: { headers: { [name: string]: string } } = { headers: {} },
  ): Promise<{
    response: http.IncomingMessage;
    ...
    const localVarPath =
      this.basePath + '/affiliate_seller/202505/marketplace_creators/search';
    const localVarQueryParameters: any = {};
    const localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders,
    ...
    if (pageSize === null || pageSize === undefined) {
      throw new Error(
        'Required parameter pageSize was null or undefined when calling MarketplaceCreatorsSearchPost.',
      );
    }
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling MarketplaceCreatorsSearchPost.',
      );
    }
    ...
    if (contentType === null || contentType === undefined) {
      throw new Error(
        'Required parameter contentType was null or undefined when calling MarketplaceCreatorsSearchPost.',
      );
    }
    ...
    const localVarRequestOptions: localVarRequest.Options = {
      ...
      json: true,
      body: ObjectSerializer.serialize(
        SellerSearchCreatoronMarketplaceRequestBody,
...
export const AffiliateSellerV202505ApiOperationNames = {
  ...
  MarketplaceCreatorsCreatorUserIdGet: 'MarketplaceCreatorsCreatorUserIdGet',
  MarketplaceCreatorsSearchPost: 'MarketplaceCreatorsSearchPost',
} as const;
