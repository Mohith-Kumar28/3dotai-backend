...
export class ProductV202407Api {
   ...
   */
  public async ListingSchemasGet(
    ...
    if (categoryIds === null || categoryIds === undefined) {
      throw new Error(
        'Required parameter categoryIds was null or undefined when calling ListingSchemasGet.',
      );
    }
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling ListingSchemasGet.',
      );
    }
    ...
    if (contentType === null || contentType === undefined) {
      throw new Error(
        'Required parameter contentType was null or undefined when calling ListingSchemasGet.',
      );
    }

    if (categoryIds !== undefined) {
      localVarQueryParameters['category_ids'] = ObjectSerializer.serialize(
        categoryIds,
        'Array<number>',
      );
    }
          ...
          if (error) {
            ...
            if (
              ...
              body = ObjectSerializer.deserialize(
                body,
                'Product202407ListingSchemasResponse',
              );
   ...
   * @param shopCipher
   */
  public async ProductsCategoryUpgradeTaskPost(
    xTtsAccessToken: string,
    contentType: string,
    shopCipher?: string,
    options: { headers: { [name: string]: string } } = { headers: {} },
    ...
    const localVarPath =
      this.basePath + '/product/202407/products/category_upgrade_task';
    const localVarQueryParameters: any = {};
    const localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders,
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling ProductsCategoryUpgradeTaskPost.',
      );
    }
    ...
    if (contentType === null || contentType === undefined) {
      throw new Error(
        'Required parameter contentType was null or undefined when calling ProductsCategoryUpgradeTaskPost.',
      );
    }
   ...
   */
  public async SizechartsSearchPost(
    pageSize: number,
    xTtsAccessToken: string,
    contentType: string,
    pageToken?: string,
    locales?: Array<string>,
    SearchSizeChartsRequestBody?: Product202407SearchSizeChartsRequestBody,
    options: { headers: { [name: string]: string } } = { headers: {} },
  ): Promise<{
    response: http.IncomingMessage;
    ...
    if (pageSize === null || pageSize === undefined) {
      throw new Error(
        'Required parameter pageSize was null or undefined when calling SizechartsSearchPost.',
      );
    }
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling SizechartsSearchPost.',
      );
    }
    ...
    if (contentType === null || contentType === undefined) {
      throw new Error(
        'Required parameter contentType was null or undefined when calling SizechartsSearchPost.',
      );
    }
    ...
    if (locales !== undefined) {
      localVarQueryParameters['locales'] = ObjectSerializer.serialize(
        locales,
        'Array<string>',
      );
    }
        ...
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            ...
            if (
              ...
              body = ObjectSerializer.deserialize(
                body,
                'Product202407SearchSizeChartsResponse',
              );
              resolve({ response: response, body: body });
            } else {
              reject(new HttpError(response, body, response.statusCode));
...
export const ProductV202407ApiOperationNames = {
  ...
  ProductsCategoryUpgradeTaskPost: 'ProductsCategoryUpgradeTaskPost',
  SizechartsSearchPost: 'SizechartsSearchPost',
} as const;
