...
export class AuthorizationV202405Api {
  ...
  public setApiKey(key: AuthorizationV202405ApiApiKeys, value: string) {
    (this.authentications as any)[AuthorizationV202405ApiApiKeys[key]].apiKey =
      value;
  }
   ...
   */
  public async CategoryAssetsGet(
    ...
    const localVarPath =
      this.basePath + '/authorization/202405/category_assets';
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling CategoryAssetsGet.',
      );
    }
    ...
    if (contentType === null || contentType === undefined) {
      throw new Error(
        'Required parameter contentType was null or undefined when calling CategoryAssetsGet.',
      );
    }
