...
export class ProductV202312Api {
  ...
  public async GlobalProductsSearchPost(
    ...
    contentType: string,
    pageToken?: string,
    SearchGlobalProductsRequestBody?: Product202312SearchGlobalProductsRequestBody,
    ...
    const localVarPath =
      this.basePath + '/product/202312/global_products/search';
  ...
  public async ProductsSearchPost(
    ...
    pageToken?: string,
    shopCipher?: string,
    SearchProductsRequestBody?: Product202312SearchProductsRequestBody,
    options: { headers: { [name: string]: string } } = { headers: {} },
  ): Promise<{
    response: http.IncomingMessage;
        ...
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            ...
            if (
              ...
              body = ObjectSerializer.deserialize(
                body,
                'Product202312SearchProductsResponse',
              );
              resolve({ response: response, body: body });
            } else {
              reject(new HttpError(response, body, response.statusCode));
