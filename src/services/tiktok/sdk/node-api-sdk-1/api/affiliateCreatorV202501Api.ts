...
export class AffiliateCreatorV202501Api {
  ...
  public setApiKey(key: AffiliateCreatorV202501ApiApiKeys, value: string) {
    (this.authentications as any)[
      AffiliateCreatorV202501ApiApiKeys[key]
    ].apiKey = value;
  }
  ...
  public async AffiliateSharingLinksGenerateBatchPost(
    ...
    contentType: string,
    GenerateAffiliateSharingLinkRequestBody?: AffiliateCreator202501GenerateAffiliateSharingLinkRequestBody,
    ...
    const localVarPath =
      this.basePath +
      '/affiliate_creator/202501/affiliate_sharing_links/generate_batch';
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling AffiliateSharingLinksGenerateBatchPost.',
      );
    }
    ...
    if (contentType === null || contentType === undefined) {
      throw new Error(
        'Required parameter contentType was null or undefined when calling AffiliateSharingLinksGenerateBatchPost.',
      );
    }
    ...
    const localVarRequestOptions: localVarRequest.Options = {
      ...
      body: ObjectSerializer.serialize(
        GenerateAffiliateSharingLinkRequestBody,
   ...
   */
  public async SelectionProductsSearchPost(
    xTtsAccessToken: string,
    contentType: string,
    pageToken?: string,
    pageSize?: number,
    CreatorSelectAffiliateProductRequestBody?: AffiliateCreator202501CreatorSelectAffiliateProductRequestBody,
    options: { headers: { [name: string]: string } } = { headers: {} },
  ): Promise<{
    response: http.IncomingMessage;
    ...
    const localVarPath =
      this.basePath + '/affiliate_creator/202501/selection/products/search';
    const localVarQueryParameters: any = {};
    const localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders,
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling SelectionProductsSearchPost.',
      );
    }
    ...
    if (contentType === null || contentType === undefined) {
      throw new Error(
        'Required parameter contentType was null or undefined when calling SelectionProductsSearchPost.',
      );
    }
    ...
    const localVarRequestOptions: localVarRequest.Options = {
      ...
      json: true,
      body: ObjectSerializer.serialize(
        CreatorSelectAffiliateProductRequestBody,
...
export const AffiliateCreatorV202501ApiOperationNames = {
  AffiliateSharingLinksGenerateBatchPost:
    'AffiliateSharingLinksGenerateBatchPost',
