...
export class AffiliateCreatorV202410Api {
  ...
  public setApiKey(key: AffiliateCreatorV202410ApiApiKeys, value: string) {
    (this.authentications as any)[
      AffiliateCreatorV202410ApiApiKeys[key]
    ].apiKey = value;
  }
  ...
  public async OrdersSearchPost(
    ...
    contentType: string,
    pageToken?: string,
    SearchCreatorAffiliateOrdersRequestBody?: AffiliateCreator202410SearchCreatorAffiliateOrdersRequestBody,
    ...
    const localVarPath =
      this.basePath + '/affiliate_creator/202410/orders/search';
    ...
    const localVarRequestOptions: localVarRequest.Options = {
      ...
      body: ObjectSerializer.serialize(
        SearchCreatorAffiliateOrdersRequestBody,
