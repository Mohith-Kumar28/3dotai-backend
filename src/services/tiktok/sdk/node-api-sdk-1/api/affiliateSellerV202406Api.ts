...
export class AffiliateSellerV202406Api {
  ...
  public setApiKey(key: AffiliateSellerV202406ApiApiKeys, value: string) {
    (this.authentications as any)[
      AffiliateSellerV202406ApiApiKeys[key]
    ].apiKey = value;
  }
  ...
  public async MarketplaceCreatorsCreatorUserIdGet(
    ...
    const localVarPath =
      this.basePath +
      '/affiliate_seller/202406/marketplace_creators/{creator_user_id}'.replace(
        '{' + 'creator_user_id' + '}',
  ...
  public async MarketplaceCreatorsSearchPost(
    ...
    pageToken?: string,
    shopCipher?: string,
    SellerSearchCreatoronMarketplaceRequestBody?: AffiliateSeller202406SellerSearchCreatoronMarketplaceRequestBody,
    options: { headers: { [name: string]: string } } = { headers: {} },
  ): Promise<{
    response: http.IncomingMessage;
    ...
    const localVarPath =
      this.basePath + '/affiliate_seller/202406/marketplace_creators/search';
    const localVarQueryParameters: any = {};
    const localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders,
