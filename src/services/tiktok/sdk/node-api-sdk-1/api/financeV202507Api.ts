...
export class FinanceV202507Api {
   ...
   * @param shopCipher
   */
  public async OrdersUnsettledGet(
    sortField: string,
    ...
    if (sortField === null || sortField === undefined) {
      throw new Error(
        'Required parameter sortField was null or undefined when calling OrdersUnsettledGet.',
      );
    }
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling OrdersUnsettledGet.',
      );
    }
    ...
    if (contentType === null || contentType === undefined) {
      throw new Error(
        'Required parameter contentType was null or undefined when calling OrdersUnsettledGet.',
      );
    }
    ...
    if (searchTimeGe !== undefined) {
      localVarQueryParameters['search_time_ge'] = ObjectSerializer.serialize(
        searchTimeGe,
        'number',
      );
    }
    ...
    if (searchTimeLt !== undefined) {
      localVarQueryParameters['search_time_lt'] = ObjectSerializer.serialize(
        searchTimeLt,
        'number',
      );
    }
