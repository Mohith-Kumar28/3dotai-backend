...
export class OrderV202309Api {
  ...
  public async OrdersGet(
    ...
    if (ids === null || ids === undefined) {
      throw new Error(
        'Required parameter ids was null or undefined when calling OrdersGet.',
      );
    }
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling OrdersGet.',
      );
    }
          ...
          if (error) {
            ...
            if (
              ...
              body = ObjectSerializer.deserialize(
                body,
                'Order202309GetOrderDetailResponse',
              );
  ...
  public async OrdersSearchPost(
    ...
    sortField?: string,
    shopCipher?: string,
    GetOrderListRequestBody?: Order202309GetOrderListRequestBody,
    options: { headers: { [name: string]: string } } = { headers: {} },
  ): Promise<{
    response: http.IncomingMessage;
        ...
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            ...
            if (
              ...
              body = ObjectSerializer.deserialize(
                body,
                'Order202309GetOrderListResponse',
              );
              resolve({ response: response, body: body });
            } else {
              reject(new HttpError(response, body, response.statusCode));
