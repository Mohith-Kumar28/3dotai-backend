...
export class ProductV202501Api {
  ...
  public async ComplianceManufacturersSearchPost(
    ...
    contentType: string,
    pageToken?: string,
    SearchManufacturersRequestBody?: Product202501SearchManufacturersRequestBody,
    ...
    const localVarPath =
      this.basePath + '/product/202501/compliance/manufacturers/search';
  ...
  public async ComplianceResponsiblePersonsSearchPost(
    ...
    contentType: string,
    pageToken?: string,
    SearchResponsiblePersonsRequestBody?: Product202501SearchResponsiblePersonsRequestBody,
    options: { headers: { [name: string]: string } } = { headers: {} },
  ): Promise<{
    response: http.IncomingMessage;
    ...
    const localVarPath =
      this.basePath + '/product/202501/compliance/responsible_persons/search';
    const localVarQueryParameters: any = {};
    const localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders,
