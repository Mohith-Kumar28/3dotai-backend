...
export class ProductV202505Api {
   ...
   */
  public async ImagesTranslationTasksPost(
    xTtsAccessToken: string,
    contentType: string,
    shopCipher?: string,
    CreateImageTranslationTasksRequestBody?: Product202505CreateImageTranslationTasksRequestBody,
    ...
    const localVarPath =
      this.basePath + '/product/202505/images/translation_tasks';
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling ImagesTranslationTasksPost.',
      );
    }
    ...
    if (contentType === null || contentType === undefined) {
      throw new Error(
        'Required parameter contentType was null or undefined when calling ImagesTranslationTasksPost.',
      );
    }
