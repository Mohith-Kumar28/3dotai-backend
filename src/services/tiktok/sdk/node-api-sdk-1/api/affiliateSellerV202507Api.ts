...
export class AffiliateSellerV202507Api {
  ...
  public setApiKey(key: AffiliateSellerV202507ApiApiKeys, value: string) {
    (this.authentications as any)[
      AffiliateSellerV202507ApiApiKeys[key]
    ].apiKey = value;
  }
  ...
  public async SampleApplicationsApplicationIdReviewPost(
    ...
    contentType: string,
    shopCipher?: string,
    SellerReviewSampleApplicationsRequestBody?: AffiliateSeller202507SellerReviewSampleApplicationsRequestBody,
    ...
    const localVarPath =
      this.basePath +
      '/affiliate_seller/202507/sample_applications/{application_id}/review'.replace(
        '{' + 'application_id' + '}',
  ...
  public async SampleApplicationsSearchPost(
    ...
    pageSize?: number,
    shopCipher?: string,
    SellerSearchSampleApplicationsRequestBody?: AffiliateSeller202507SellerSearchSampleApplicationsRequestBody,
    options: { headers: { [name: string]: string } } = { headers: {} },
  ): Promise<{
    response: http.IncomingMessage;
    ...
    const localVarPath =
      this.basePath + '/affiliate_seller/202507/sample_applications/search';
    const localVarQueryParameters: any = {};
    const localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders,
