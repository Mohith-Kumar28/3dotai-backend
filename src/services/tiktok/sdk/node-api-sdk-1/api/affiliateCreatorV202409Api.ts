...
export class AffiliateCreatorV202409Api {
  ...
  public setApiKey(key: AffiliateCreatorV202409ApiApiKeys, value: string) {
    (this.authentications as any)[
      AffiliateCreatorV202409ApiApiKeys[key]
    ].apiKey = value;
  }
   ...
   */
  public async SampleApplicationsFulfillmentsSearchPost(
    xTtsAccessToken: string,
    contentType: string,
    sortOrder?: string,
    sortField?: string,
    CreatorSearchSampleApplicationFulfillmentsRequestBody?: AffiliateCreator202409CreatorSearchSampleApplicationFulfillmentsRequestBody,
    ...
    const localVarPath =
      this.basePath +
      '/affiliate_creator/202409/sample_applications/fulfillments/search';
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling SampleApplicationsFulfillmentsSearchPost.',
      );
    }
    ...
    if (contentType === null || contentType === undefined) {
      throw new Error(
        'Required parameter contentType was null or undefined when calling SampleApplicationsFulfillmentsSearchPost.',
      );
    }
    ...
    const localVarRequestOptions: localVarRequest.Options = {
      ...
      body: ObjectSerializer.serialize(
        CreatorSearchSampleApplicationFulfillmentsRequestBody,
  ...
  public async ShowcasesProductsDelete(
    xTtsAccessToken: string,
    contentType: string,
    RemoveShowcaseProductsRequestBody?: AffiliateCreator202409RemoveShowcaseProductsRequestBody,
    options: { headers: { [name: string]: string } } = { headers: {} },
  ): Promise<{
    response: http.IncomingMessage;
    ...
    const localVarPath =
      this.basePath + '/affiliate_creator/202409/showcases/products';
    const localVarQueryParameters: any = {};
    const localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders,
    ...
    const localVarRequestOptions: localVarRequest.Options = {
      ...
      json: true,
      body: ObjectSerializer.serialize(
        RemoveShowcaseProductsRequestBody,
  ...
  public async ShowcasesProductsTopPost(
    xTtsAccessToken: string,
    contentType: string,
    TopShowcaseProductsRequestBody?: AffiliateCreator202409TopShowcaseProductsRequestBody,
    options: { headers: { [name: string]: string } } = { headers: {} },
  ): Promise<{
    response: http.IncomingMessage;
    ...
    const localVarPath =
      this.basePath + '/affiliate_creator/202409/showcases/products/top';
    const localVarQueryParameters: any = {};
    const localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders,
    ...
    const localVarRequestOptions: localVarRequest.Options = {
      ...
      json: true,
      body: ObjectSerializer.serialize(
        TopShowcaseProductsRequestBody,
...
export const AffiliateCreatorV202409ApiOperationNames = {
  SampleApplicationsFulfillmentsSearchPost:
    'SampleApplicationsFulfillmentsSearchPost',
