...
export class DataReconciliationV202401Api {
  ...
  public setApiKey(key: DataReconciliationV202401ApiApiKeys, value: string) {
    (this.authentications as any)[
      DataReconciliationV202401ApiApiKeys[key]
    ].apiKey = value;
  }
   ...
   */
  public async OrdersImportPost(
    xTtsAccessToken: string,
    contentType: string,
    shopCipher?: string,
    QualityFactoryOrderDataImportAPIRequestBody?: DataReconciliation202401QualityFactoryOrderDataImportAPIRequestBody,
    ...
    const localVarPath =
      this.basePath + '/data_reconciliation/202401/orders/import';
    ...
    if (xTtsAccessToken === null || xTtsAccessToken === undefined) {
      throw new Error(
        'Required parameter xTtsAccessToken was null or undefined when calling OrdersImportPost.',
      );
    }
    ...
    if (contentType === null || contentType === undefined) {
      throw new Error(
        'Required parameter contentType was null or undefined when calling OrdersImportPost.',
      );
    }
